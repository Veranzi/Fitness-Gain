"""
Django settings for fitness_journal project.
...
SECRET_KEY = 'django-insecure-8v=04r(5#1t7s!d=uq#tltvy$cjp-0hx72jjb3da%8ml6f&#%j'
...
WSGI_APPLICATION = 'fitness_journal.wsgi.application'
